                ...
                while not check_ok:
                    ...
                    if (
                        ...
                        self.translation_stage.abs_move(axis=self.axis_mapping_dict[axis],
                                                        ...
                                                        vel=vel, wait=wait)
                        print(f"COMMAND axis:{axis}, pos:{pos}")
                        print(f"ACTUAL axis:{self.axis_mapping_dict[axis]}, pos:{self.axis_direction_dict[axis] * pos}")
                    else:
                        check_ok = True
        else:
...
if __name__ == "__main__" :
    ...
    # combined_stage.return_to_zero()
    # combined_stage.return_to_zero_safe()
    # combined_stage.seek_and_set_zero()
    # exit()
    # combined_stage.transform_to_combined()
    # combined_stage.abs_move('z', -5, 5, True)
    combined_stage.abs_move('x', -80, 5, True)
    # combined_stage.abs_move('y', 150, 5, True)
    # combined_stage.abs_move('theta', -75, vel=10, wait=True)
